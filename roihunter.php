...
class Roihunter extends Module
{
    ...
    protected $keys   = array('id', 'access_token', 'google_conversion_id', 'google_conversion_label', 'fb_pixel_id');
 ...
 /************************** hooks start ******************************/
    ...
    public function hookDisplayFooter($params)
    {
        ...
        } elseif(Tools::getValue('controller') == 'category' && (int)Tools::getValue('id_category') && !empty($google_conversion_id)) {
        ...
        } elseif(Tools::getValue('controller') == 'orderconfirmation' &&  (int)Tools::getValue('id_order')) {
    ...
    public function hookActionCartSave($params)
    {
        ...
        if(Tools::getValue('add')) {
            $res = array('id_product'=>(int)Tools::getValue("id_product"), 'id_product_attribute' =>  (int)Tools::getValue("ipa"), 'quantity'=>Tools::getValue('qty'));
            $pridani[] = $res;
...
/************************** controller start ******************************/
    ...
    */
    ...
    public function getIframeUrl() {
          switch (Configuration::get('ROIHUNTER_ACTIVEBEPROFILE', null, null, $id_shop) ){
            case 0: return 'https://goostav-fe-staging.roihunter.com'; // staging
            case 1: return 'https://magento.roihunter.com';
         }
    ...
    protected function postProcess()
    {
        ...
        $integers = array('ROIHUNTER_ACTIVEBEPROFILE');
